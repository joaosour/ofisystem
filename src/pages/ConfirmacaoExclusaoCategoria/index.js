...
export default function ConfirmacaoExclusaoCategoria() {
...
>
        ...
        <View style={styles.modalContent}>
              <Text style={styles.modalText}>Categoria Excluida com Sucesso!</Text>
            </View>

            <TouchableOpacity style = {styles.buttonBack} onPress={ () => navigation.navigate('Catalog')} >
