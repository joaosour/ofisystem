...
export default function ConfirmacaoCadastroMod() {
...
>
        ...
        <View style={styles.modalContent}>
              <Text style={styles.modalText}>Novo Modelo Cadastrado com Sucesso!</Text>
            </View>

            <TouchableOpacity style = {styles.button1} onPress={ () => navigation.navigate('CadastroModelo')} >
